...
openmp_clauses! {
    ...
    DeviceSafesync => { name: "device_safesync", rule: ClauseRule::Parenthesized },
    ...
    Full => { name: "full", rule: ClauseRule::Parenthesized },
    ...
    InitComplete => { name: "init_complete", rule: ClauseRule::Parenthesized },
    Indirect => { name: "indirect", rule: ClauseRule::Parenthesized },
    ...
    NoOpenmpConstructs => { name: "no_openmp_constructs", rule: ClauseRule::Parenthesized },
    ...
    Read => { name: "read", rule: ClauseRule::Parenthesized },
    ...
    Replayable => { name: "replayable", rule: ClauseRule::Parenthesized },
    ReverseOffload => { name: "reverse_offload", rule: ClauseRule::Parenthesized },
    ...
    Safesync => { name: "safesync", rule: ClauseRule::Parenthesized },
    Schedule => { name: "schedule", rule: ClauseRule::Parenthesized },
    SelfMaps => { name: "self_maps", rule: ClauseRule::Parenthesized },
    ...
    Simd => { name: "simd", rule: ClauseRule::Parenthesized },
    ...
    Write => { name: "write", rule: ClauseRule::Parenthesized },
