...
openmp_clauses! {
    ...
    Full => { name: "full", rule: ClauseRule::Bare },
    ...
    InitComplete => { name: "init_complete", rule: ClauseRule::Bare },
    ...
    Safesync => { name: "safesync", rule: ClauseRule::Bare },
...
openmp_directives! {
    ...
    BeginDeclareTarget => "begin declare_target",
    BeginDeclareVariant => "begin declare_variant",
    BeginMetadirective => "begin metadirective",
    Cancel => "cancel",
    CancellationPoint => "cancellation_point",
    Critical => "critical",
    DeclareInduction => "declare_induction",
    DeclareMapper => "declare_mapper",
    DeclareReduction => "declare_reduction",
    DeclareSimd => "declare_simd",
    DeclareTarget => "declare_target",
    DeclareVariant => "declare_variant",
    Depobj => "depobj",
    Dispatch => "dispatch",
    ...
    TargetEnterData => "target_enter_data",
    TargetExitData => "target_exit_data",
