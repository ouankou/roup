...
openmp_clauses! {
    Absent => { name: "absent", rule: ClauseRule::Flexible },
    AcqRel => { name: "acq_rel", rule: ClauseRule::Bare },
    Acquire => { name: "acquire", rule: ClauseRule::Bare },
    AdjustArgs => { name: "adjust_args", rule: ClauseRule::Flexible },
    Affinity => { name: "affinity", rule: ClauseRule::Parenthesized },
    Align => { name: "align", rule: ClauseRule::Flexible },
    ...
    AppendArgs => { name: "append_args", rule: ClauseRule::Flexible },
    Apply => { name: "apply", rule: ClauseRule::Flexible },
    At => { name: "at", rule: ClauseRule::Flexible },
    ...
    Collector => { name: "collector", rule: ClauseRule::Flexible },
    Combiner => { name: "combiner", rule: ClauseRule::Flexible },
    Collapse => { name: "collapse", rule: ClauseRule::Parenthesized },
    Compare => { name: "compare", rule: ClauseRule::Flexible },
    Contains => { name: "contains", rule: ClauseRule::Flexible },
    Counts => { name: "counts", rule: ClauseRule::Flexible },
    ...
    Enter => { name: "enter", rule: ClauseRule::Flexible },
    ...
    GraphId => { name: "graph_id", rule: ClauseRule::Flexible },
    GraphReset => { name: "graph_reset", rule: ClauseRule::Flexible },
    HasDeviceAddr => { name: "has_device_addr", rule: ClauseRule::Flexible },
    ...
    Initializer => { name: "initializer", rule: ClauseRule::Flexible },
    Indirect => { name: "indirect", rule: ClauseRule::Flexible },
    Induction => { name: "induction", rule: ClauseRule::Flexible },
    Inductor => { name: "inductor", rule: ClauseRule::Flexible },
    ...
    Local => { name: "local", rule: ClauseRule::Flexible },
    Link => { name: "link", rule: ClauseRule::Parenthesized },
    Looprange => { name: "looprange", rule: ClauseRule::Flexible },
    Map => { name: "map", rule: ClauseRule::Parenthesized },
    Memscope => { name: "memscope", rule: ClauseRule::Flexible },
    ...
    Nocontext => { name: "nocontext", rule: ClauseRule::Flexible },
    ...
    Otherwise => { name: "otherwise", rule: ClauseRule::Flexible },
    ...
    Permutation => { name: "permutation", rule: ClauseRule::Flexible },
    ...
    Severity => { name: "severity", rule: ClauseRule::Flexible },
    ...
    Threadset => { name: "threadset", rule: ClauseRule::Flexible },
    ...
    Uniform => { name: "uniform", rule: ClauseRule::Flexible },
    ...
    Use => { name: "use", rule: ClauseRule::Flexible },
