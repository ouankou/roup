...
fn convert_clause(clause: &Clause) -> OmpClause {
    ...
    let (kind, data) = match normalized_name.as_str() {
        // Complete OpenMP 5.2 clause mapping (132 unique clauses)
        "absent" => (0, ClauseData { default: 0 }),
        "acq_rel" => (1, ClauseData { default: 0 }),
        "acquire" => (2, ClauseData { default: 0 }),
        "adjust_args" => (3, ClauseData { default: 0 }),
        "affinity" => (4, ClauseData { default: 0 }),
        "align" => (5, ClauseData { default: 0 }),
        "aligned" => (6, ClauseData { default: 0 }),
        "allocate" => (7, ClauseData { default: 0 }),
        "allocator" => (8, ClauseData { default: 0 }),
        "append_args" => (9, ClauseData { default: 0 }),
        "apply" => (10, ClauseData { default: 0 }),
        "at" => (11, ClauseData { default: 0 }),
        "atomic_default_mem_order" => (12, ClauseData { default: 0 }),
        "bind" => (13, ClauseData { default: 0 }),
        "capture" => (14, ClauseData { default: 0 }),
        "collapse" => (15, ClauseData { default: 0 }),
        "collector" => (16, ClauseData { default: 0 }),
        "combiner" => (17, ClauseData { default: 0 }),
        "compare" => (18, ClauseData { default: 0 }),
        "contains" => (19, ClauseData { default: 0 }),
        "copyin" => (20, ClauseData { default: 0 }),
        "copyprivate" => (21, ClauseData { default: 0 }),
        "counts" => (22, ClauseData { default: 0 }),
        "default" => (23, ClauseData { default: 0 }),
        "defaultmap" => (24, ClauseData { default: 0 }),
        "depend" => (25, ClauseData { default: 0 }),
        "destroy" => (26, ClauseData { default: 0 }),
        "detach" => (27, ClauseData { default: 0 }),
        "device" => (28, ClauseData { default: 0 }),
        "device_resident" => (29, ClauseData { default: 0 }),
        "device_safesync" => (30, ClauseData { default: 0 }),
        "device_type" => (31, ClauseData { default: 0 }),
        "dist_schedule" => (32, ClauseData { default: 0 }),
        "doacross" => (33, ClauseData { default: 0 }),
        "dynamic_allocators" => (34, ClauseData { default: 0 }),
        "enter" => (35, ClauseData { default: 0 }),
        "exclusive" => (36, ClauseData { default: 0 }),
        "fail" => (37, ClauseData { default: 0 }),
        "final" => (38, ClauseData { default: 0 }),
        "filter" => (39, ClauseData { default: 0 }),
        "firstprivate" => (40, ClauseData { default: 0 }),
        "from" => (41, ClauseData { default: 0 }),
        "full" => (42, ClauseData { default: 0 }),
        "grainsize" => (43, ClauseData { default: 0 }),
        "graph_id" => (44, ClauseData { default: 0 }),
        "graph_reset" => (45, ClauseData { default: 0 }),
        "has_device_addr" => (46, ClauseData { default: 0 }),
        "hint" => (47, ClauseData { default: 0 }),
        "holds" => (48, ClauseData { default: 0 }),
        "if" => (49, ClauseData { default: 0 }),
        "in_reduction" => (50, ClauseData { default: 0 }),
        "induction" => (51, ClauseData { default: 0 }),
        "inductor" => (52, ClauseData { default: 0 }),
        "inbranch" => (53, ClauseData { default: 0 }),
        "inclusive" => (54, ClauseData { default: 0 }),
        "init" => (55, ClauseData { default: 0 }),
        "init_complete" => (56, ClauseData { default: 0 }),
        "initializer" => (57, ClauseData { default: 0 }),
        "indirect" => (58, ClauseData { default: 0 }),
        "interop" => (59, ClauseData { default: 0 }),
        "is_device_ptr" => (60, ClauseData { default: 0 }),
        "label" => (61, ClauseData { default: 0 }),
        "lastprivate" => (62, ClauseData { default: 0 }),
        "linear" => (63, ClauseData { default: 0 }),
        "link" => (64, ClauseData { default: 0 }),
        "local" => (65, ClauseData { default: 0 }),
        "looprange" => (66, ClauseData { default: 0 }),
        "map" => (67, ClauseData { default: 0 }),
        "match" => (68, ClauseData { default: 0 }),
        "message" => (69, ClauseData { default: 0 }),
        "memscope" => (70, ClauseData { default: 0 }),
        "mergeable" => (71, ClauseData { default: 0 }),
        "nocontext" => (72, ClauseData { default: 0 }),
        "nogroup" => (73, ClauseData { default: 0 }),
        "no_openmp" => (74, ClauseData { default: 0 }),
        "no_openmp_constructs" => (75, ClauseData { default: 0 }),
        "no_openmp_routines" => (76, ClauseData { default: 0 }),
        "no_parallelism" => (77, ClauseData { default: 0 }),
        "nontemporal" => (78, ClauseData { default: 0 }),
        "notinbranch" => (79, ClauseData { default: 0 }),
        "novariants" => (80, ClauseData { default: 0 }),
        "nowait" => (81, ClauseData { default: 0 }),
        "num_tasks" => (82, ClauseData { default: 0 }),
        "num_teams" => (83, ClauseData { default: 0 }),
        "num_threads" => (84, ClauseData { default: 0 }),
        "order" => (85, ClauseData { default: 0 }),
        "ordered" => (86, ClauseData { default: 0 }),
        "otherwise" => (87, ClauseData { default: 0 }),
        "partial" => (88, ClauseData { default: 0 }),
        "permutation" => (89, ClauseData { default: 0 }),
        "priority" => (90, ClauseData { default: 0 }),
        "private" => (91, ClauseData { default: 0 }),
        "proc_bind" => (92, ClauseData { default: 0 }),
        "public" => (93, ClauseData { default: 0 }),
        "read" => (94, ClauseData { default: 0 }),
        "reduction" => (95, ClauseData { default: 0 }),
        "release" => (96, ClauseData { default: 0 }),
        "relaxed" => (97, ClauseData { default: 0 }),
        "replayable" => (98, ClauseData { default: 0 }),
        "reproducible" => (99, ClauseData { default: 0 }),
        "reverse" => (100, ClauseData { default: 0 }),
        "reverse_offload" => (101, ClauseData { default: 0 }),
        "safelen" => (102, ClauseData { default: 0 }),
        "safesync" => (103, ClauseData { default: 0 }),
        "schedule" => (104, ClauseData { default: 0 }),
        "self_maps" => (105, ClauseData { default: 0 }),
        "seq_cst" => (106, ClauseData { default: 0 }),
        "severity" => (107, ClauseData { default: 0 }),
        "shared" => (108, ClauseData { default: 0 }),
        "simd" => (109, ClauseData { default: 0 }),
        "simdlen" => (110, ClauseData { default: 0 }),
        "sizes" => (111, ClauseData { default: 0 }),
        "task_reduction" => (112, ClauseData { default: 0 }),
        "thread_limit" => (113, ClauseData { default: 0 }),
        "threads" => (114, ClauseData { default: 0 }),
        "threadset" => (115, ClauseData { default: 0 }),
        "tile" => (116, ClauseData { default: 0 }),
        "to" => (117, ClauseData { default: 0 }),
        "transparent" => (118, ClauseData { default: 0 }),
        "unified_address" => (119, ClauseData { default: 0 }),
        "unified_shared_memory" => (120, ClauseData { default: 0 }),
        "uniform" => (121, ClauseData { default: 0 }),
        "unroll" => (122, ClauseData { default: 0 }),
        "untied" => (123, ClauseData { default: 0 }),
        "update" => (124, ClauseData { default: 0 }),
        "use" => (125, ClauseData { default: 0 }),
        "use_device_addr" => (126, ClauseData { default: 0 }),
        "use_device_ptr" => (127, ClauseData { default: 0 }),
        "uses_allocators" => (128, ClauseData { default: 0 }),
        "weak" => (129, ClauseData { default: 0 }),
        "when" => (130, ClauseData { default: 0 }),
        "write" => (131, ClauseData { default: 0 }),
...
fn directive_name_to_kind(name: *const c_char) -> i32 {
    ...
    unsafe {
        ...
        match name_str.to_lowercase().as_str() {
            // Complete OpenMP 5.2 directive mapping (132 unique directives)
            // Generated from OpenMP IR enum values
            "allocate" => 0,
            "allocators" => 1,
            "assume" => 2,
            "assumes" => 3,
