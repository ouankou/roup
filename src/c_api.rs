...
fn convert_clause(clause: &Clause) -> OmpClause {
    ...
    let (kind, data) = match normalized_name.as_str() {
        ...
        "proc_bind" => (13, ClauseData { default: 0 }),
        "linear" => (14, ClauseData { variables: ptr::null_mut() }),
        "aligned" => (15, ClauseData { variables: ptr::null_mut() }),
        "safelen" => (16, ClauseData { default: 0 }),
        "simdlen" => (17, ClauseData { default: 0 }),
        "nontemporal" => (18, ClauseData { variables: ptr::null_mut() }),
        "dist_schedule" => (19, ClauseData { default: 0 }),
        "num_teams" => (20, ClauseData { default: 0 }),
        "thread_limit" => (21, ClauseData { default: 0 }),
        "grainsize" => (22, ClauseData { default: 0 }),
        "num_tasks" => (23, ClauseData { default: 0 }),
        "copyprivate" => (24, ClauseData { variables: ptr::null_mut() }),
        "filter" => (25, ClauseData { default: 0 }),
        "priority" => (26, ClauseData { default: 0 }),
        "device" => (27, ClauseData { default: 0 }),
        "map" => (28, ClauseData { variables: ptr::null_mut() }),
        "depend" => (29, ClauseData { variables: ptr::null_mut() }),
        "use_device_ptr" => (30, ClauseData { variables: ptr::null_mut() }),
        "use_device_addr" => (31, ClauseData { variables: ptr::null_mut() }),
        "is_device_ptr" => (32, ClauseData { variables: ptr::null_mut() }),
        "has_device_addr" => (33, ClauseData { variables: ptr::null_mut() }),
        "affinity" => (34, ClauseData { variables: ptr::null_mut() }),
        "allocate" => (35, ClauseData { variables: ptr::null_mut() }),
        "allocator" => (36, ClauseData { default: 0 }),
        "order" => (38, ClauseData { default: 0 }),
        "bind" => (39, ClauseData { default: 0 }),
        "seq_cst" => (42, ClauseData { default: 0 }),
        "acq_rel" => (43, ClauseData { default: 0 }),
        "release" => (44, ClauseData { default: 0 }),
        "acquire" => (45, ClauseData { default: 0 }),
        "relaxed" => (46, ClauseData { default: 0 }),
        "read" => (47, ClauseData { default: 0 }),
        "write" => (48, ClauseData { default: 0 }),
