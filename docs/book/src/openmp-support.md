...
| Feature | Support |
|---------|---------|
| **OpenMP Version** | 6.0 (latest) |
| **Directives** | 120+ directives (all core + combined forms) |
| **Clauses** | 92 clause types |
...
**All directive and clause keywords from OpenMP 6.0 are fully supported.** ✅
