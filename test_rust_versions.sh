...
#   ./test_rust_versions.sh 1.88 stable  # Test specific versions
#   ./test_rust_versions.sh 1.88 1.89 stable  # Test intermediate versions too
#
# How it works:
